    ...
    MeshInstance* test_spheres() 
    {
        static const auto mesh = Mesh
        {
            ...
            new Sphere
            {
                ...
                {
                    .albedo = glm::vec3{ .56f, .518f, .835f },
                    .emission = glm::vec3{ 10.f, 9.9f, 9.8f },
                    .metallicity = .9f,
                    .anisotropy = 0.f,
                    .roughness = .8f,
                }
